...
| detailed payment, booking, report, queue, NPZ, DICOM, retry, and controller detail | IMPLEMENTATION EVIDENCE / ARCHITECTURE DECISION / OPEN DECISION | Not duplicated into orientation; inspect authoritative source, target implementation, or obtain approval as applicable. |
