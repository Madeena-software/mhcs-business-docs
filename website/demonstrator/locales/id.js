...
window.MHCS_LOCALES.id = {
      ...
      "doctor.goToOperator": "Buka Site Staff (Radiography)",
      ...
      "doctor.empty.none.copy": "Selesaikan akuisisi citra di ruang kerja Site Staff (Radiography), lalu lanjutkan ke antrean ini.",
      ...
      "journey.copy.0": "Pemeriksaan lanjutan diperlukan. Tindakan berikutnya terlihat bagi Site Staff (Radiography).",
      "journey.copy.1": "Site Staff (Radiography) sedang menyiapkan citra fiktif. Konfirmasi masih diperlukan.",
      ...
      "announcement.imagingOpened": "Tugas radiografi dibuka. Akuisisi citra kini menjadi tahap saat ini bagi Site Staff (Radiography).",
