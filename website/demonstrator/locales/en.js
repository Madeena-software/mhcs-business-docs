...
window.MHCS_LOCALES.en = {
      ...
      "view.member": "Member · WhatsApp view",
      "view.operator": "Site Staff (Radiography)",
      ...
      "member.state.0.actor": "Site Staff (Radiography)",
      ...
      "member.state.1.actor": "Site Staff (Radiography)",
      ...
      "doctor.goToOperator": "Go to Site Staff (Radiography)",
      ...
      "doctor.empty.none.copy": "Complete image acquisition in the Site Staff (Radiography) workspace, then continue to this queue.",
      ...
      "journey.copy.0": "Further examination is required. The next action is visible to the Site Staff (Radiography).",
      "journey.copy.1": "The Site Staff (Radiography) is preparing the fictional image. Confirmation is still required.",
      ...
      "announcement.imagingOpened": "Imaging task opened. Image acquisition is now the current step for the Site Staff (Radiography).",
